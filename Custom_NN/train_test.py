...
def run_auto_mpg():
    ...
    plot.plot_feature_vs_pred(X_test, y_test, y_pred, "displacement", 'mpg')
    plot.plot_feature_vs_pred(X_test, y_test, y_pred, "cylinders", 'mpg')
    plot.plot_feature_vs_pred(X_test, y_test, y_pred, "acceleration", 'mpg')
...
def run_boston():
    ...
    plot.plot_loss_vs_epoch(num_epochs, losses)
    plot.plot_feature_vs_pred(X_test, y_test, y_pred, "CRIM", 'MEDV')
